...
export default function Home() {
  ...
  const sendSecretMessage = async () => {
    ...
    try {
      // Send email using a free service (works without backend)
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          ...
          setShowPopup(false); // Close main popup too
        }, 2000);
      }
    } catch (error) {
  ...
  return (
    <>
      ...
      {/* Full-screen popup with secret box trigger */}
      {showPopup && (
            ...
            <div className="popup-message">
              ...
              <div className="popup-text">
                ...
                <span className="popup-signature">
                  Thanks Ms.dutta and ba-byeeee<br />
                  behala basiiiii
                </span>
              </div>
              
              {/* Secret trigger button - looks like part of design but opens secret box */}
              <div className="secret-trigger" onClick={() => setShowSecretBox(true)}>
                <span className="secret-trigger-text">🤫</span>
                <span className="secret-trigger-hover">ami kichu miss korle...</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Secret message box - opens from popup */}
      {showSecretBox && (
        <div className="secret-overlay" onClick={() => setShowSecretBox(false)}>
          <div className="secret-box" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="secret-title">
              ...
              <span className="secret-subtitle">(don't worry - amar kache hoito pouchabe na msg ta)</span>
            </div>
            
            {sendSuccess ? (
              <div className="secret-success">
                ✨ pochabe na, kintu ami peye gechi ✨
              </div>
            ) : (
              <>
                <textarea
      ...
      <div className="slideshow-container" ref={slideshowRef}>
        ...
        <section className="slide page-1">
          ...
          <div className="memory-content">
            <p className="memory-line">1. Our late night such dukkho sharing on the last 2 days of 2025 which was a tough and exhausthing year for us a bit more for you tha mine</p>
            <p className="memory-line">2. The promise we made on the last day of the year that on the new year we will only talk about positivity and will not look at our pats and will only do things that will make us happy and will peace of our min and that 2026's GLOw of yours to remain always</p>
            <p className="memory-tag">31st December, 11:47 PM</p>
          </div>
        </section>
        ...
        <section className="slide page-2">
          ...
          <div className="memory-content">
            ...
            <p className="memory-line">5. remember our song singings in chat? I do one line u do another? our sangeet bangla song collection can still will defeat many</p>
        ...
        <section className="slide page-3">
          ...
          <div className="memory-content">
            <p className="memory-line">7. us learning git together in google meet may be the first time we talked other than WhatsApp and me trying to answer your questions using chatgpt (funny way)</p>
            ...
            <p className="memory-line">9. you sharing your pithe making and showing me and I am on awe how can u maange to do all these and so gracefully and also misiing not tasting them</p>
            <p className="memory-line">10. our coffee shop opening planning with something named after dutta's</p>
          </div>
        </section>
        ...
        <section className="slide page-4">
          ...
          <div className="memory-content">
            ...
            <p className="memory-line">12. remember us mirrong while talking?</p>
            <p className="memory-line">13. our late nightrashi nakshatra finding me by chatgpt u by your pure knowledge(still I feel my rashi showing wrong things as I am still losing people</p>
            <p className="memory-line">14. our first movie of 2026 together and me getting surprised khud surprise dene gaya tha mai</p>
            <p className="memory-line">15. that tea at Nandan and veg momo and phuchka I still crave for that company that evening is still the best evening of my Kolkata days</p>
          </div>
        </section>
        ...
        <section className="slide page-5">
          ...
          <div className="memory-content">
            ...
            <p className="memory-line">18. tor amake kolkatar alda alada ki ki valo jins ache kothai valo ki pawa jai bola</p>
        ...
        <section className="slide page-6">
          <div className="bg-behala-large">বেহালা</div>
          <div className="bg-shantiniketan-large">শান্তিনিকেতন</div>
        ...
        <section className="slide page-7">
          <div className="bg-behala-full">বেহালা</div>
          ...
          <div className="memory-content highlight">
            <p className="memory-line large">23. and last but not the list amar firstime kono close friend er birthday tar sathe tar jaigai katano and tar sathe tar behala ghure dekha I will always cheris 23rd of February every year this day will keep me smiling and cherishing this memory and yesss ami Sourav ganguly er bari dekhechiiiii ekhon proudly bole beracchi due to you</p>
            <p className="memory-tag highlight">23rd February — Ei din ta thakbe amar</p>
          </div>
        </section>
        ...
        <section className="slide page-8">
          ...
          <div className="memory-content final">
            <p className="memory-line large">Eto din, eto kotha</p>
            <p className="memory-line">Likhte likhte dekhi onek hoye geche. Ei website ta — ei sob memories — tomar jonno noy. Amar jonno. Kintu tor sathe share korar ichhe holoo. Jodi dekhis, dek. Na dekhis, othoba na. Kono expectation nei. Sudhu e toku chaai — tui jabi valo thakbi. 2026 r glow ta jeno chirokal thake.</p>
            <p className="memory-tag">Thanks for the memories.</p>
          </div>
        </section>
      </div>
    </>
